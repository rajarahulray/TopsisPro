...
if net <=35 :
    ...
    for i in range(net):
         l = Label(r, text = "network = {}".format(i+1)).place(x = 10 , y = 40 + y_inc);
         #l.config(x = 10, y = 40 + y_inc);
         
         eth = Entry(r);
         lth.append(eth);
         eth.place(x = 100, y = 40 + y_inc);
         
         eth = Entry(r);
         lj.append(eth);
         eth.place(x = 240, y = 40 + y_inc);
         
         eth = Entry(r);
         ld.append(eth);
         eth.place(x = 380, y = 40 + y_inc);
         
         eth = Entry(r);
         llr.append(eth);
         eth.place(x = 520, y = 40 + y_inc);
         
         eth = Entry(r);
         lc.append(eth);
         eth.place(x = 660, y = 40 + y_inc);
    ...
    r.geometry('820x{}'.format(y_inc + 130));
